  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>User <small>Create new a acount for user</small></h2>
          ...
          <div class="x_content">
            ...
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="../../../controllers/users/create.php">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" pattern=".{3,50}" name="password" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <!--/password -->
              ...
              <!-- email -->
               <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="email" id="first-name" pattern=".{3,}" name="email" required="required" class="form-control col-md-7 col-xs-12" step="any">
                </div>
              </div>
              <!--/email-->
              ...
              <!-- phone_number -->
               <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="number" id="first-name" name="phone_number" required="required" class="form-control col-md-7 col-xs-12" step="any">
                </div>
              </div>
              <!--/phone_number-->
                ...
                <div class="form-group">
                  ...
                  <div id="hot" class="btn-group" data-toggle="buttons">
                    <label class="btn btn-default " data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                        <input type="radio" name="lever" value="1" > &nbsp; Admin
                    </label>
                    <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                        <input type="radio" name="lever" value="0"> Collaborators
                    </label>
                  </div>
                  </div>
                </div>
